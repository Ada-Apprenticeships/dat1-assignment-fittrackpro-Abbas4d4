...
VALUES (
    CURRENT_TIMESTAMP,  -- Set check-in time to current time
...
SELECT
 l.name, -- Selects the name of the location
...
GROUP BY l.location_id, l.name; -- Groups results by location ID and name to get averages